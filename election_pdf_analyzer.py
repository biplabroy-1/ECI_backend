...
# GROQ_API_KEY = r"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"  # Set your Groq API key here
...
def extract_pdf_metadata(pdf_path):
    ...
    try:
        ...
        metadata = {"constituency": "", "district": "", "total_pages": len(reader.pages)}
...
def convert_pdf_to_images(pdf_path, start_page=3):
    ...
    try:
        ...
        images = convert_from_path(
            ...
            fmt='jpeg',
            thread_count=4,
            # poppler_path=r"C:\Program Files\poppler-25.08.0\poppler-23.11.0\Library\bin"  # Path to Poppler binaries
...
def save_to_json(data, json_file_path):
    ...
    try:
        ...
        try:
            if "voters" in data and isinstance(data["voters"], list):
                with open(json_file_path, 'w', encoding='utf-8') as f:
                    json.dump({"metadata": default_structure["metadata"], "all_voters": data["voters"]}, f, ensure_ascii=False, indent=2)
        except:
...
def process_all_images(image_paths, output_folder, api_key):
    ...
    for i, image_path in enumerate(image_paths, 1):
        ...
        print(f"Extracted {voters_in_page} voters from this page. Total so far: {total_voters}")
...
def main():
    ...
    #if GROQ_API_KEY == r"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":
    #    print("Error: Please set your GROQ_API_KEY in the configuration section")
    #    return
    ...
    try:
        ...
        image_paths, output_folder = convert_pdf_to_images(PDF_PATH, start_page=3)
